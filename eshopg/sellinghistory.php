    ...
    <div class="container-fluid">
        <div class="row">
            ...
            for ($x = 0; $x < $selected_num; $x++) {
                ...
                $pro_rs =  Database::search("SELECT * FROM `product` WHERE `id` ='" . $selected_data["product_id"] . "'");
...
<div class="col-12 mt-2" id="viewArea">
                    <div class="row">
                        ...
                        <div class="col-1 bg-secondary text-end">
                            <label class="form-label fs-5 fw-bold text-white mt-1 mb-1"><?php echo $x + 1; ?></label>
                        </div>
                        <div class="col-3 bg-body text-center">
                            <label class="form-label fs-5 fw-bold text-black mt-1 mb-1"><?php echo $pro_data["title"] ?></label>
                        </div>
                        <div class="col-3 bg-secondary text-center">
                            <label class="form-label fs-5 fw-bold text-white mt-1 mb-1"><?php echo $sell_data["fname"] . " " . $sell_data["lname"] ?></label>
                        </div>
                        <div class="col-2 bg-body text-center">
                            <label class="form-label fs-5 fw-bold text-black mt-1 mb-1">Rs. <?php echo $selected_data["total"] ?> .00</label>
                        </div>
                        <div class="col-1 bg-secondary text-center">
                            <label class="form-label fs-5 fw-bold text-white mt-1 mb-1"><?php echo $selected_data["qty"] ?> Items</label>
                        </div>
