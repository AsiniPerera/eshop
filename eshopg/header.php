                ...
                <div class="row">
                    ...
                    <div class="col-2 col-lg-6 dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="message.php" onclick="window.location.reload();">Message</a></li>
                            <li><a class="dropdown-item" href="#" onclick="contactAdmin('<?php echo $_SESSION['u']['email'];  ?>');">Contact Admin</a></li>
                        </ul>
                    </div>

                    <div class="col-1 col-lg-3 ms-5 ms-lg-0 mt-1 cart-icon signout" onclick="window.location = 'cart.php'"></div>
                    <!-- msgmodel -->
