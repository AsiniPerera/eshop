                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-1 col-lg-1 bg-light py-2 d-grid">
                            ...
                            ?>
                                <button class="btn btn-danger" id="ub<?php echo $selected_data['email']; ?>" onclick="bockuser('<?php echo $selected_data['email']; ?>');">Block</button>
                            <?php
                            } else {
                            ?>
                                <button class="btn btn-success" id="ub<?php echo $selected_data['email']; ?>" onclick="bockuser('<?php echo $selected_data['email']; ?>');">Unblock</button>
                            <?php
                            }
